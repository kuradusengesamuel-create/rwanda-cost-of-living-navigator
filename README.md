...
Every month, Rwanda's National Institute of Statistics (NISR) publishes inflation figures. But what does, for instance "14.5% inflation" actually mean for a family in Musanze, a shopkeeper in Nyamirambo, or a government planner in Kigali?

The honest answer is: nobody knows because the national average treats everyone the same. A family spending most of its income on food feels inflation very differently from one spending mostly on rent or transport.
...
The Rwanda Cost-of-Living Navigator takes official NISR data and turns it into something personal and useful. You enter what you actually spend money on, and the platform tells you:
...
Enter your monthly income and what you spend on food, transport, rent, health, and education. 
Get your personal inflation rate, a spotlight on your biggest pressure, and practical budgeting tips. 
Share your results directly on WhatsApp.

#### Tier 2. Business Tool
See which cost categories are rising fastest, get a signal for wage review conversations, and plan ahead with a short-term cost forecast.

#### Tier 3. Government Dashboard
A color-coded district pressure index built by combining live CPI trends with EICV7 household spending patterns
showing where cost-of-living pressure is highest and which income groups are most at risk.
...
Every forecast is clearly marked as a model estimate, not a confirmed local price.
